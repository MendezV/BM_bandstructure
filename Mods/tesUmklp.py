...
for l in range(Npoi_u):
    ...
    printProgressBar(l + 1, Npoi_u, prefix = 'Progress Diag2:', suffix = 'Complete', length = 50)
...
FFp=Hamiltonian.FormFactors(psi_plus, 1, lq,umkl)
L00p=FFp.NemFFL_a()
FFc3=Hamiltonian.FormFactors(psi_plusc3, 1, lq,umkl)
L00m=FFc3.NemFFL_a()
print(np.shape(L00p),np.shape(L00m) )

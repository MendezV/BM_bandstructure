...
class ep_Bubble:
    ...
    def integrand_T(self,nkq,nk,ekn,ekm,w,mu,T):
        ...
        eps=0.02*self.eta ##SENSITIVE TO DISPERSION
    ...
    def parCompute(self,  omegas, kpath, VV, Nsamp,  mu):
        ...
        self.plot_res( integ, self.KX,self.KY, VV, mu, Nsamp,c, res, "eps")
    ...
    def Fill_sweep(self,fillings, mu_values,VV, Nsamp, c_phonon):
        ...
        calc = functools.partial(self.parCompute,  omega, kpath, VV, Nsamp)
        maxthreads=12

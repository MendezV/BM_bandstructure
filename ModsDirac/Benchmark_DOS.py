...
class ee_Bubble:
    ...
    def __init__(self, latt, nbands, hpl, hmin, test, umkl, theta):
        ...
        if test:
            ...
            [self.bins,self.valt, self.f2 ]=disp.DOS(self.Ene_valley_plus_dos,self.Ene_valley_min_dos)
            [self.earr,self.dosarr,self.f2 ]=disp.DOS2(self.Ene_valley_plus_dos,self.Ene_valley_min_dos,1/np.size(self.KXdos))

...
jobname="Rec_g2"  #JOBNAME importan to declare -has to be descriptive
...
for param_val in ${param_arr[@]}; do
	...
	nohup time python3 -u Reconstruction.py ${Lattice_size} ${filling_seed} ${param_val} ${kappa} ${Mode_HF} ${phonon_polarization} >> output.out	
